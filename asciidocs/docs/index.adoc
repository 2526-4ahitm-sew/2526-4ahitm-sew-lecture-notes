...
* Dienen als Abbild der tatsächlichen Geschäftsobjekte (z. B. User, Product, Cart) -> Bsp: Wie in den Filmen früher, die Regale in denen die Akten der Leute waren

=== Klassendiagramm angezeigt bekommen
* Klassen markieren -> rechtsklick -> Diagramms -> Java Klassen -> Diagram wird angezeigt
** Fields Feld und show Dependencies anklicken -> Beziehungen und Attribute werden angegzeigt.
...
* **Stammdaten**
** Langfristig gültige, selten veränderte Grunddaten
** Beschreiben Objekte/Personen unabhängig von Vorgängen
** Beispiele: Kunden, Produkte, Mitarbeiter

* **Bewegungsdaten**
** Kurzfristig gültige Daten, entstehen durch Geschäftsprozesse
